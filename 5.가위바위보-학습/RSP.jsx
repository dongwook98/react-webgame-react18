...
import useInterval from './useInterval'; // 커스텀 훅 불러오기
...
const RSP = () => {
  ...
  const [isRunning, setIsRunning] = useState(true); // interval을 멈추기위한 state
  // useInterval로 묶어줌 (useRef와 uesEffect)
  ...
  const onClickBtn = (choice) => () => {
    if (isRunning) {
      // 멈췄을 때 또 클릭하는 것 막기
      setIsRunning(false); // interval 중지
